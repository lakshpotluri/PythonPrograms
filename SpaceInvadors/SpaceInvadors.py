...
def hehehe_you_lost():
    ...
    global no
    global screen
    lol = pygame.image.load('space.png')
    screen.blit(lol,(0,0))
    #white = (255,255,255)
    #screen.fill(white)
...
while tort is True:
    ...
    while neter is True:
        ...
        def sp():
            ...
            screen.blit(yc4,(20,80))
        sp()
        
        tt10 = 'Controls'
        yc11 = pygame.font.Font('long_shot.ttf',90)
        def s1():
        ...
        def s2():
            yc14 = yc13.render(tt11,True,(255,255,255 ))
            screen.blit(yc14,(20,110))
        
        s2()
        ttt = 'To move right = right arrow'
        yc100 = pygame.font.Font('tor.ttf',30)
        def s9():
            yc15 = yc100.render(ttt,True,(255,255,255 ))
            screen.blit(yc15,(20,140))
